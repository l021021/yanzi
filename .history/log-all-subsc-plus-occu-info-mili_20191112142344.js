                            ...
                            switch (json.list[0].list[0].resourceType) {
                                case 'SampleMotion': //sampleMotion
                                    ...
                                    if (temp1 == (json.list[0].list[0].value - 1)) { //Value changed!
                                        ...
                                        recordObj.value = 'in'
                                            // motionTimeStamps.push(json.list[0].dataSourceAddress.did + ',in,' + _t1.getTime());
                                        temprecordObj = JSON.pars(JSON.stringify(recordObj));
                                        ...
                                        temprecordObj = JSON.pars(JSON.stringify(recordObj));
                                        motionTimeStamps.push(temprecordObj)
                                            //motionTimeStamps += json.list[0].dataSourceAddress.did + ',ot,' + _t1.getTime() + '\n';

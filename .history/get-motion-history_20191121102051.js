        ...
        if (message.type === 'utf8') {
            ...
            if (json.messageType == 'ServiceResponse') {
                ...
                if (json.responseCode.name == 'success' && json.sampleListDto.list) {
                    ...
                    //Process records
                    switch (json.sampleListDto.list[0].resourceType) { //json.sampleListDto.list[0].resourceType  json.sampleListDto.list[0].sampleTime  json.sampleListDto.list[0].value
                        case 'SampleList':

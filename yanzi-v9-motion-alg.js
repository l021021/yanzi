            ...
            switch (json.messageType) {
                ...
                case 'LoginResponse':
                    if (json.responseCode.name == 'success') {
                        ...
                        sendSubscribeRequest("229349"); //test
                    ...
                    switch (json.list[0].resourceType) {
                        case 'SampleList':
                            ...
                            switch (json.list[0].dataSourceAddress.variableName.name) {
                                case 'motion':
                                    _t1.setTime(json.list[0].list[0].sampleTime); //sensor periodic sampling time
                                ...
                                case 'assetUtilization':
                                    ...
                                    console.log(_Counter + '# ' + _t2.toLocaleTimeString() + ' ASSETU ' + json.list[0].dataSourceAddress.did + ' @ ' + _t3.toLocaleTimeString() +
                                        ' free:' + json.list[0].list[0].free + ' occupied:' + json.list[0].list[0].occupied);
                                    break;
                                case 'unitState':
                                    _t2.setTime(json.timeSent);
                                    _t3.setTime(json.list[0].list[0].sampleTime);
                                    console.log(_Counter + '# ' + _t2.toLocaleTimeString() + ' UNTSTA ' + json.list[0].dataSourceAddress.did + ' @ ' + _t3.toLocaleTimeString() + '  ' +
                                        json.list[0].list[0].assetState.name);
                                    break;
                                case 'percentage':
                                    _t2.setTime(json.timeSent);
                                    _t3.setTime(json.list[0].list[0].sampleTime);
                                    console.log(_Counter + '# ' + _t2.toLocaleTimeString() + ' PCTAG% ' + json.list[0].dataSourceAddress.did + ' @ ' + _t3.toLocaleTimeString() +
                                        ' Occu%:' + json.list[0].list[0].value);
                                    break;
                                case 'uplog':
                                    _t2.setTime(json.list[0].list[0].sampleTime);
                                    console.log(_Counter + '# ' + _t2.toLocaleTimeString() + ' UPLOG ' + json.list[0].dataSourceAddress.did + ' ' + json.list[0].list[0].resourceType);

                ...
                for (var i = 0; i < json.list.length; i++) {
                  ...
                  if (!_locationExist) {
                    locationObj.locationId =
                      json.list[i].locationAddress.locationId
                    locationObj.serverDid =
                      json.list[i].locationAddress.serverDid
              ...
              case 'EventDTO':
                ...
                switch (json.list[0].eventType.name) {
                  ...
                  case 'locationChanged':
                    ...
                    eventObj.did =
                      json.list[0].list[0].locationAddress.serverDid
                    eventObj.locationId =
                      json.list[0].list[0].locationAddress.locationId
                    break
                  default:
                    console.log(
                      '!!!! cannot understand this resourcetype ' +
